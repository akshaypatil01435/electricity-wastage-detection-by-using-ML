...
import com.wattvision.backend.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    /** The filter runs inside the Spring Security chain only; stop Boot from also registering it as a servlet filter. */
    @Bean
